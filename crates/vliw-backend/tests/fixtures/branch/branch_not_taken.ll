...
; entry stores 0 to mem[0x100], loads it back, and compares (val > 0).
; Stored value 0 > 0 is false → the if.else branch is taken → r1 = 0.
define i32 @main() {
entry:
  store volatile i32 0, ptr inttoptr (i64 256 to ptr), align 4
